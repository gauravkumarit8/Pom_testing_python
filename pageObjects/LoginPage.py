...
class LoginPage:
    ...
    def __init__(self,driver):
        self.driver=driver
        self.textbox_username_id=(By.ID,"Email")
        self.textbox_password_id=(By.ID,"Password")
        self.button_login_xpath=(By.XPATH,"/html/body/div[6]/div/div/div/div/div[2]/div[1]/div/form/div[3]/button")
        self.link_logout_linktext=(By.LINK_TEXT,"Logout")
